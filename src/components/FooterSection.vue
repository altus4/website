    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="py-8 border-t border-gray-800">
        <div class="text-center mb-6">
          <h4 class="text-lg font-semibold mb-4">Built With</h4>
          <div class="flex flex-wrap items-center justify-center gap-8">
            ...
            <div class="flex items-center space-x-2 text-gray-300">
              <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/express/express-original.svg" alt="Express.js" class="h-6 w-6 filter invert" />
      ...
      <!-- Bottom Footer -->
      <div class="py-6 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between">
        <div class="text-gray-400 text-sm mb-4 md:mb-0">
          © 2024 Altus 4. Open source project by <a href="https://thavarshan.com" target="_blank" rel="noopener noreferrer" class="text-white hover:text-blue-400 transition-colors">Thavarshan</a>.
        </div>
